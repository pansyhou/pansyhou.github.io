export const projects: Project[] = [
  ...
  //   source: 'https://github.com/pansy/kz-admin',
  ...
  //   source: 'https://github.com/pansy/api-service',
  ...
  //   source: 'https://github.com/pansy/protocol',
  //   tags: ['opensource', 'favorite'],
  //   type: 'web',
  // },
  // {
  ...
  //   source: 'https://github.com/pansy/hoppx',
  //   tags: ['opensource'],
  //   type: 'web',
  // },
  // {
  ...
  //   source: 'https://github.com/pansy/link-maker',
  //   tags: ['opensource'],
  //   type: 'web',
  // },
  // {
  ...
  //   source: 'https://github.com/pansy/image-hosting',
  //   tags: ['opensource'],
  //   type: 'web',
  // },
  // {
  ...
  //   source: 'https://github.com/pansy/example',
  ...
  //   source: 'https://github.com/pansy/vitesse-nuxt3-strapi',
  //   tags: ['opensource'],
  //   type: 'web',
  // },
  // {
  ...
  //   source: 'https://github.com/pansy/js-de-obfuscator',
  //   tags: ['opensource'],
  //   type: 'web',
  // },
  // {
  ...
  //   source: 'https://github.com/pansy/vscode-extension',
  //   tags: ['opensource'],
  //   type: 'web',
  // },
  // {
  ...
  //   website: 'https://github.com/pansy/eslint-config',
  //   tags: ['opensource', 'personal'],
  //   type: 'personal',
  // },
  // {
  //   title: 'browser-rpc',
  //   description: 'WebSocket远程调用浏览器函数',
  //   website: 'https://github.com/pansy/rpc-browser',
  //   tags: ['opensource'],
  //   type: 'personal',
  // },
  // {
  ...
  //   website: 'https://github.com/pansy/rust-wasm-md5',
  //   tags: ['opensource'],
  //   type: 'personal',
  // },
]
