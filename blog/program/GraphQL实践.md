...
仓库本文实例代码仓库： [kuizuo/nest-graphql-demo](https://github.com/pansy/nest-graphql-demo 'kuizuo/nest-graphql-demo')
...
这里我就选用 [kuizuo/vitesse-nuxt-strapi](https://github.com/pansy/vitesse-nuxt-strapi 'kuizuo/vitesse-nuxt-strapi') 作为演示，并为其提供 graphQL 支持。
